...
```{r}
#Creating a time series for each soil moisture site
...
## NOTES: trend component seems to explain much of the variability in sites 3 & 4
## NOTES: seasonality component seems to explain more of the variability in sites 1 & 2
...
## NOTES: precip on y axis, soil moisture x axis
## NOTES: output will tell you if the relationship between soil moisture & precip is significant

lm_site1 <- lm(data = site1_soil_precip, formula = AverageMonthlySmois30 ~ AverageMonthlyPrecip)
summary(lm_site1)
## NOTES: precip is significant, p-value < 0.05
## NOTES: 1 unit increase in precip leads to a 0.047911 unit increase in soil moisture

lm_site2 <- lm(data = site2_soil_precip, formula = AverageMonthlySmois30 ~ AverageMonthlyPrecip)
summary(lm_site2)
## NOTES: precip is NOT significant, p-value > 0.05
