...
```{r}
#Averaging rain gage data by month
...
```{r}
#Joining the soil moisture monthly average dataframe to the dataframe of monthly precipitation from the nearest rain gage. 
