...
class(Coweeta_wrangled2$smois60)
...
#seasonality component seems to explain much of the variability in sites 3 & 4
#trend component seems to explain more of the variability in sites 1 & 2
...
#Spearman Rho: no seasonality, non-parametric, missing data allowed. Function: `cor.test(method="spearman")` (package: stats) - can detect nonlinear trends
