...
#image: ![Study Sites and Recording Rain Gage #Locations]("/home/guest/Zungailia_Davidson_McClaugherty/Data/precipandsmois.png")
```
...
|AverageMonthlySmois30| Unitless (measured as a percent) | Numeric | Site 1: minimum = 0.1521, mean = 0.2804, maximum = 0.3556, Site 2: minimum = 0.1046, mean = 0.2543, maximum = 0.3421, Site 3: minimum = 0.114, mean = 0.2729, maximum = 0.5753, Site 4: minimum = 0.1383, mean = 0.3156, maximum = 0.4922 |
