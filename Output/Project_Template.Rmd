...
```{r Average Monthly Soil Moisture Cowplot, echo = FALSE, fig.height = 7, fig.width = 8, fig.cap = "Average Monthly Soil Moisture", message=FALSE}
...
```{r Average Monthly Precipitation Cowplot, echo = FALSE, fig.height = 7, fig.width = 8, fig.cap = "Average Monthly Precipitation", message=FALSE}
...
```{r Average Monthly Soil Moisture and Precipitation Plots, echo = FALSE, message=FALSE}
...
```{r Average Monthly Soil Moisture and Precipitation Cowplot, echo = FALSE, fig.height = 7, fig.width = 8, message=FALSE, fig.cap = "Average monthly soil moisture and precipitation"}
