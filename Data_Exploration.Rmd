...
```{r}
#Plotting average monthly precipitation at the three rain gages closest to our sites to look at trends over time

RG5_Plot <-
  ggplot(RG5_MonthlyAvg, aes(x = YearMonth, y = AverageMonthlyPrecip)) +
  geom_line()+
  geom_smooth(method = lm) +
  labs(x = 'Year', y = 'Average Monthly Precipitation (in.)', title = 'Rain Gage 5') +
  stat_regline_equation()
print(RG5_Plot)
...
RG6_Plot <-
  ...
  geom_line()+
  geom_smooth(method = lm) +
  labs(x = 'Year', y = 'Average Monthly Precipitation (in.)', title = 'Rain Gage 6') +
  stat_regline_equation()
print(RG6_Plot)
...
RG31_Plot <-
  ...
  geom_line()+
  geom_smooth(method = lm) +
  labs(x = 'Year', y = 'Average Monthly Precipitation (in.)', title = 'Rain Gage 31') +
  stat_regline_equation()
print(RG31_Plot)
